(function () {
    ...
    mainCtrl.$inject = ['$scope', '$rootScope', '$location', '$layout', '$layoutToggles', '$pageLoadingBar', 'Fullscreen'];
    function mainCtrl($scope, $rootScope, $location, $layout, $layoutToggles, $pageLoadingBar, Fullscreen) {
